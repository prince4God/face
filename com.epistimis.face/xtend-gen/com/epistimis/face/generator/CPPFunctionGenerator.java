...
public class CPPFunctionGenerator extends CommonFunctionGenerator implements IFaceLangGenerator {
  private static Logger logger = Logger.getLogger(CPPFunctionGenerator.class);
   ...
   */
  public CPPFunctionGenerator(final QueryUtilities qu) {
  ...
  public String genParameter(final UopConnection conn) {
    ...
    if (_isEmpty) {
      ...
      CPPFunctionGenerator.logger.error(_plus_1);
