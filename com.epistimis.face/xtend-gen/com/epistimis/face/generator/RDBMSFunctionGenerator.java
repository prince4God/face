...
public class RDBMSFunctionGenerator extends CommonFunctionGenerator implements IFaceLangGenerator {
  private static Logger logger = Logger.getLogger(RDBMSFunctionGenerator.class);
   ...
   */
  public RDBMSFunctionGenerator(final QueryUtilities qu) {
  ...
  public String compileUopCommon(final UopUnitOfPortability uop, final Collection<PlatformEntity> entities) {
    ...
    _builder.append("/** THIS IS CPP NOT SQL or SDL. Need to change this completely !!!! */");
    _builder.newLine();
  ...
  public String genParameter(final UopConnection conn) {
    ...
    if (_isEmpty) {
      ...
      RDBMSFunctionGenerator.logger.error(_plus_1);
    ...
    String _plus_2 = (_typeString + " ");
    String _genParameterName = this.genParameterName(conn);
    return (_plus_2 + _genParameterName);
  }
}
