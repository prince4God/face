...
public class ScalaFunctionGenerator extends CommonFunctionGenerator implements IFaceLangGenerator {
  private static Logger logger = Logger.getLogger(ScalaFunctionGenerator.class);
   ...
   */
  public ScalaFunctionGenerator(final QueryUtilities qu) {
  ...
  public String genParameter(final UopConnection conn) {
    ...
    if (_isEmpty) {
      ...
      ScalaFunctionGenerator.logger.error(_plus_1);
